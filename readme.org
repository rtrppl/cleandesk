...
This function (and =cleandesk-move-files=) is using fd, which can rapidly process 1000s of directories. Just to give you an idea: In my setup Cleandesk operates with more than 5000 directories and there is no delay whatsoever!
